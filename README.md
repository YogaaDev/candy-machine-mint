...
git config --global user.email yogaadev@outlook.com
git config --global user.name YogaaDev

npm install gh-pages --save-dev

git init

git remote add origin git@github.com:YogaaDev/candy-machine-mint.git
